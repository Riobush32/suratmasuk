<x-dashboard>
    ...
    <div class="w-full flex justify-center mb-20">
        <div class="border-gray-300 border text-gray-300 p-5 rounded-xl  max-w-[1100px]">
            <div class="">
                <legend class="text-2xl">Add Klasifikasi</legend>
                <hr class="my-2">
            </div>
            <form action="{{ route('klasifikasiStore') }}" method="POST" class="">
                @csrf
                <div class="flex flex-wrap gap-4">
                    <label class="text-black form-control w-full max-w-xs">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" id="nomor_serat"
                            ...
                            placeholder="klasifikasi name" required />
